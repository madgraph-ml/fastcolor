...
class gg_7g:
    ...
    def apply_preprocessing(self, reverse = False, eps=1e-10):
        ...
        if "lorentz_products" not in self.params["parameterisation"]:
            ...
            phi_channels = []
            eta_channels = []
            mass_channels = [i for i in self.channels if i < 36]
            factor_channels = [36]
        ...
        if "lorentz_products" not in self.params["parameterisation"]:
            ...
            self.observables.append(
                Observable(
                    ...
                    tex_label=r"p_{g_{1}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    ...
                    tex_label=r"p_{g_{2}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    ...
                    tex_label=r"p_{g_{3}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    ...
                    tex_label=r"p_{g_{4}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 28]),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 29]),
                    tex_label=r"p_{g_{5}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 30]),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 31]),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 32]),
                    tex_label=r"p_{g_{6}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 33]),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 34]),
                    tex_label=r"p_{g_{7}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
            ...
            self.observables.append(
                Observable(
                    compute=lambda p: return_obs(p[..., :], p[..., 35]),
                    tex_label=r"p_{g_{8}}\cdot p_{g_{9}}",
                    unit="GeV",
                    bins=lambda obs: get_hardcoded_bins(
                        n_bins=n_bins + 1, lower=0, upper=5e5
                    ),
